...
MMEngine has implemented varies of initlizers in
https://github.com/open-mmlab/mmengine/blob/main/mmengine/model/weight_init.py
...
from armitage.registry import WEIGHT_INITIALIZERS
